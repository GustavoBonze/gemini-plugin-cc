...
argument-hint: '[--wait|--background] [--base <ref>] [--scope auto|working-tree|branch] [--depth low|medium|high] [--thinking] [--model flash|pro|<model>] [--cwd <dir>] [--prompt-file <path>] [focus ...]'
