...
argument-hint: "[--background|--wait] [--resume|--fresh] [--effort none|minimal|low|medium|high|xhigh] [--depth low|medium|high] [--thinking] [--thinking-budget <tokens>] [--image <path>] [--model flash|pro|<model>] [--cwd <dir>] [--prompt-file <path>] [what Gemini should investigate, solve, or continue]"
context: fork
