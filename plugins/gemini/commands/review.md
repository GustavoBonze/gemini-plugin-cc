...
argument-hint: '[--wait|--background] [--base <ref>] [--scope auto|working-tree|branch] [--effort none|minimal|low|medium|high|xhigh] [--depth low|medium|high] [--thinking] [--thinking-budget <tokens>] [--image <path>] [--model flash|pro|<model>] [--cwd <dir>] [--prompt-file <path>]'
...
- Otherwise, estimate the review size before asking:
  ...
  - Only conclude there is nothing to review when the relevant working-tree status is truly empty.
