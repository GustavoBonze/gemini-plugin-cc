...
Leverage the large context window — include full file contents when relevant.
...
Use when the task involves diagrams, screenshots, or visual artifacts.

```xml
<multimodal_context>
Analyze the provided visual artifacts alongside the code and text context.
Reference specific visual elements when they inform your findings.
</multimodal_context>
```
