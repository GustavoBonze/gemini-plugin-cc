...
Use these as starting templates for Gemini rescue prompts.
...
Use the available repository context to identify the most likely root cause.
Leverage the full context window — read all relevant files completely, not just snippets.
</task>
...
Use the full context window to read all changed files completely.
</task>
