...
- Review or adversarial review: add `grounding_rules`, `output_contract`, and emphasis on material findings only.
- Research or recommendation tasks: add `research_mode` and citation requirements.
